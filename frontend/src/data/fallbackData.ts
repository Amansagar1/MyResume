  ...
  projects: [
    {
      ...
      description:
        "A full-stack automation platform featuring a Next.js UI and an asynchronous Python/Flask backend integrated with LLM APIs for automated content customization.",
      highlights: [
      ...
      demo: "https://my-resume-amber-alpha.vercel.app",
      github: "https://github.com/Amansagar1",
