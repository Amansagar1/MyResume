  ...
  return (
    <div className="flex flex-col items-center mb-8 relative z-20">
      ...
      >
        ...
        <div className="absolute -inset-0.5 bg-gradient-to-r from-violet-600 via-fuchsia-600 to-indigo-600 rounded-full blur-md opacity-40 group-hover:opacity-75 transition duration-500 group-hover:duration-200 animate-pulse" />

        {/* Main Pill Surface */}
        <div className="relative px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-zinc-950/90 border border-violet-500/40 backdrop-blur-xl shadow-2xl flex items-center gap-2 sm:gap-3 flex-wrap justify-center text-xs">
          
          {/* Live Signal Beacon Indicator */}
          <div className="flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 font-mono text-[10px] font-semibold tracking-wider">
          ...
          {/* Location Badge */}
          <div className="hidden md:flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-violet-500/10 border border-violet-500/30 text-violet-300 font-mono text-[11px]">
          ...
          <button
            ...
            className="flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white font-semibold text-[11px] shadow-sm hover:shadow-violet-500/30 transition-all active:scale-95 cursor-pointer ml-0.5"
      ...
      <AnimatePresence>
        {isExpanded && (
          <motion.div
            ...
            className="w-full max-w-2xl mt-3 p-4 sm:p-5 rounded-2xl bg-zinc-950/95 border border-violet-500/30 backdrop-blur-2xl shadow-[0_20px_50px_rgba(0,0,0,0.8),0_0_30px_rgba(139,92,246,0.15)] text-left"
          >
            {/* Header info */}
            ...
            <div className="pt-3 border-t border-zinc-850 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
              ...
              <div className="flex items-center gap-2 w-full sm:w-auto">
                <button
                  onClick={scrollToContact}
                  className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-1.5 px-4 py-2 rounded-xl bg-gradient-to-r from-violet-600 via-indigo-600 to-fuchsia-600 hover:brightness-110 text-white font-bold text-xs shadow-md shadow-violet-500/20 active:scale-95 transition-all cursor-pointer"
                >
