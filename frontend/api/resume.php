<?php
// d:\proj\frontend\api\resume.php
...
try {
    ...
    // Convert Mongo object to PHP array
    ...
    // If connection fails, return 200 OK with static fallback + warning details
    $resume = $initialData;
    $resume['mongodb_status'] = "disconnected";
    $resume['mongodb_error'] = $e->getMessage();
